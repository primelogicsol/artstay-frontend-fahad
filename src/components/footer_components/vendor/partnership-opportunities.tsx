...
export default function PartnershipOpportunities() {
  return (
    <div className="space-y-12">
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">Growth Opportunities</h3>
      ...
      <div className="bg-gradient-to-br from-[#005380]/5 to-[#0085CC]/10 rounded-2xl p-8">
        <h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">Partnership Eligibility</h3>
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
        <h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">Partnership Success Stories</h3>
      ...
      <div className="text-center bg-gradient-to-r from-[#005380] to-[#0085CC] p-8 rounded-xl text-white">
        ...
        <h3 className="text-2xl font-bold mb-4">Ready to Scale with ArtStay?</h3>
