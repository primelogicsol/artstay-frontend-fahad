...
import { FairForm } from "~/components/join/fair/fair-form";
import { cn } from "~/lib/utils";

export const FairRegistrationStatus = () => {
  ...
  const {
    ...
    refetch,
  } = api.fair.getApplicationStatus.useQuery(undefined, {
  ...
  if (session.status === "authenticated" && fairData) {
    const isApproved = fairData.isActive === true;
    ...
    return (
      <Card className="overflow-hidden border-gray-200 shadow-sm">
        ...
        <CardHeader className="pb-2">
          <div className="mb-2 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-xl">
                {isApproved
                  ? "Fair Application Approved"
                  : "Fair Application Under Review"}
              </CardTitle>
            </div>
          ...
          <CardDescription>
            {isApproved
              ? "Congratulations! Your fair registration has been approved. You can now access the fair dashboard."
              : "Your fair registration is currently being reviewed by our team. We'll notify you once there's an update."}
          </CardDescription>
        </CardHeader>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                >
                  {isApproved
                    ? "Your fair registration has been approved. You're now a verified fair organizer on our platform."
              ...
              <div className="flex w-full flex-col items-center md:w-1/4">
                <div className="relative h-40 w-40 overflow-hidden rounded-full border-4 border-primary/10">
                  {fairData.dp ? (
                    <Image
                      src={fairData.dp}
                      alt={`${fairData.firstName} ${fairData.lastName}`}
                      fill
                ...
                <h2 className="mt-3 text-center font-heading text-xl font-semibold">
                  {fairData.firstName} {fairData.lastName}
                </h2>
                <div className="mt-1 text-center text-sm text-gray-600">
                  Fair ID: {fairData.fairId}
                </div>
                ...
                >
                  {isApproved ? "VERIFIED FAIR" : "VERIFICATION PENDING"}
                </Badge>
              </div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="flex items-start gap-3 rounded-lg bg-gray-50 p-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{fairData.address}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 rounded-lg bg-gray-50 p-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{fairData.accountId}</p>
                    </div>
                  </div>
                  ...
                  <div className="col-span-2 flex items-start gap-3 rounded-lg bg-gray-50 p-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{fairData.description}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-8 flex justify-center gap-4 border-t border-gray-200 pt-4">
            {isApproved && (
              <Button variant="default" asChild>
                <Link href="/dashboard/fair" target="_blank">
                  <CheckCircle className="h-4 w-4" />
                  Go to Fair Dashboard
                </Link>
              </Button>
            )}
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex flex-col space-y-4 rounded-xl border border-primary/10 bg-primary/5 p-6">
              ...
              <p className="text-center text-sm text-gray-600">
                If you&apos;ve already submitted a fair registration
                application, log in to check its status
              </p>
              <Button
            ...
            <div className="flex flex-col space-y-4 rounded-xl border border-primary/10 bg-primary/5 p-6">
              ...
              <h3 className="text-center text-lg font-medium">
                New Fair Registration?
              </h3>
              <p className="text-center text-sm text-gray-600">
                If you&apos;re looking to register a new fair on our platform,
  ...
  // Show the form if user clicked "Start Fair Application"
  return (
    <Card className="border-gray-200 shadow-sm">
      <CardHeader className="space-y-1">
        <div className="flex items-center gap-2">
          ...
          <CardTitle>Fair Application Form</CardTitle>
        </div>
